...
sys.path.insert(0, "/home/z/my-project/v487_work")
sys.path.insert(0, "/home/z/my-project/v485_work")  # symlink fallback

print("=== v4.8.7 sanity check ===\n")

# 1. db.py: busy_timeout
print("[1] db.py: connect_args + PRAGMA busy_timeout...")
with open("/home/z/my-project/v487_work/db.py") as f:
    db_src = f.read()
...
with open("/home/z/my-project/v487_work/web_app.py") as f:
    wa_src = f.read()
...
with open("/home/z/my-project/v487_work/bot_handlers.py") as f:
    bh_src = f.read()
...
calls = re.findall(r"_spawn_background_task\s*\(", bh_src)
# Subtract 1 for the definition line (def _spawn_background_task...)
def_count = len(re.findall(r"def\s+_spawn_background_task\s*\(", bh_src))
...
print("\n[13] templates/base.html: changelog для v4.8.7 присутствует...")
with open("/home/z/my-project/v487_work/templates/base.html") as f:
    base_src = f.read()

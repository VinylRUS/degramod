...
class TestAppVersion(unittest.TestCase):
    ...
    def test_version_bumped(self):
        # v4.7.23+: APP_VERSION стал больше v4.6.1 (legacy assertion).
        # Проверяем формат и что версия >= v4.5.3 (минимальная для night mode features).
        ...
        self.assertGreaterEqual(
            ...
            f"APP_VERSION {v} should be >= v4.5.3 (night mode features)",
        )

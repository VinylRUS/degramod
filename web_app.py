...
def create_app(lifespan=None, bot=None) -> FastAPI:
    ...
    # роуты подключены через app.include_router выше; _cleanup_counts
    # импортирован в create_app() (см. late-imports) — на него всё ещё
    # ссылается admin_settings_page ниже.

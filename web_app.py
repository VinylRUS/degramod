...
роутеры из web/. Собственных роутов не содержит: все 54 маршрута веб-панели
живут в web/*.py и подключаются в create_app() через include_router. Семь из
них вынесены в v4.8.9/v4.8.10, остальные 47 — в v4.10.0 (Task 10 плана
стабилизации).

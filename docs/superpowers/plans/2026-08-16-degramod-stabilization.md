...
**Флаг на проде не снят намеренно.** Правильный порядок — выкатить версию с
fail-safe, оставив флаг, убедиться по логам, что всё спокойно, и только потом
снимать. Снятие флага — отдельное решение владельца, а не часть этой задачи.
